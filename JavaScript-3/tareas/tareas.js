...
function incrementarPorUno(array) {
  ...
  // y devuelve el array
  // Tu código:
  let nuevoArray = array.map(num => num +1);
  return nuevoArray;
}
...
function agregarItemAlComienzoDelArray(array, elemento) {
  ...
  // Tu código:
  let unshift = array.unshift(elemento);
  return array;
}
...
function agregarNumeros(numeros) {
  ...
  // Tu código:
  let resultado = numeros.reduce((x,y)=>{
    return x+y 
  },0)
  return resultado;
}
...
function mayorACien(array) {
  ...
  // Tu código:
  let nuevoArray = array.filter(numero => numero > 100);
  return nuevoArray;
}
